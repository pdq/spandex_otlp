...
defmodule Opentelemetry.Proto.Trace.V1.Status.DeprecatedStatusCode do
  @moduledoc false
  use Protobuf, enum: true, protoc_gen_elixir_version: "0.10.0", syntax: :proto3
...
defmodule Opentelemetry.Proto.Trace.V1.ResourceSpans do
  ...
  field(:instrumentation_library_spans, 2,
    repeated: true,
    type: Opentelemetry.Proto.Trace.V1.InstrumentationLibrarySpans,
...
defmodule Opentelemetry.Proto.Trace.V1.InstrumentationLibrarySpans do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.10.0", syntax: :proto3
...
defmodule Opentelemetry.Proto.Trace.V1.Status do
  ...
  field(:deprecated_code, 1,
    type: Opentelemetry.Proto.Trace.V1.Status.DeprecatedStatusCode,
